...
fn setup_template_test_current(
    ...
    if cargo_toml_path.exists() {
        ...
        writeln!(
            ...
            r#"
[patch.crates-io]
multiversx-chain-vm-executor = {{ git = "https://github.com/xorewa/mx-vm-executor-rs", rev = "a72bba88d41c31fff4502811c8835a2296072017" }}
multiversx-chain-vm-executor-wasmer-experimental = {{ git = "https://github.com/xorewa/mx-vm-executor-rs", rev = "a72bba88d41c31fff4502811c8835a2296072017" }}
"#
        ).unwrap();
    }
